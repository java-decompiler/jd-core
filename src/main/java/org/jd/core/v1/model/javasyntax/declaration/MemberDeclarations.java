...
public class MemberDeclarations<T extends MemberDeclaration> extends DefaultList<T> implements BaseMemberDeclaration {
    ...
    public MemberDeclarations(Collection<T> collection) {
        super(collection);
        assert (collection != null) && (collection.size() > 1) : "Uses 'MemberDeclaration' implementation instead";
    }

    @SuppressWarnings("unchecked")
    public MemberDeclarations(T declaration, T... declarations) {
