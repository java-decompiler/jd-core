...
public class Statements<S extends Statement> extends DefaultList<S> implements BaseStatement {
    ...
    public Statements(List<S> list) {
        super(list);
        assert (list != null) && (list.size() > 1) : "Uses 'Statement' implementation instead";
    }

    @SuppressWarnings("unchecked")
    public Statements(S statement, S... statements) {
